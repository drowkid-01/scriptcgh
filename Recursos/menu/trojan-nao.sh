...
EOF
	...
	wget https://raw.githubusercontent.com/CuervoCool/chukkmod/main/Recursos/menu/trojan-nao-sh/web.zip >/dev/null 2>&1
	...
	rm -f latest
	wget https://raw.githubusercontent.com/CuervoCool/chukkmod/main/Recursos/menu/trojan-nao-sh/trojan-1.16.0-linux-amd64.tar.xz >/dev/null 2>&1
...
start_menu(){
    ...
    green " Edicion ChuKK-SCRIPT - ADM         "
    blue " Declaración："
